...
The black contour line indicates the protein atoms. The box dimensions are 30 x 30 nm. A grid of 0.3 x 0.3 nm bins was used to map the lipids MSD. The x-axis (and y-axis) range is 6-to-24 nm. 
